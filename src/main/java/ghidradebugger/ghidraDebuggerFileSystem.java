...
@FileSystemInfo(type = "fstypegoeshere", // ([a-z0-9]+ only)
		description = "File system description goes here", factory = ghidraDebuggerFileSystem.MyFileSystemFactory.class)
public class ghidraDebuggerFileSystem implements GFileSystem {
	 ...
	 */
	public ghidraDebuggerFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + ghidraDebuggerFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<ghidraDebuggerFileSystem>, GFileSystemProbeFull {

		@Override
		public ghidraDebuggerFileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			ghidraDebuggerFileSystem fs = new ghidraDebuggerFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
